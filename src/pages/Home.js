...
const Home = () => {
  return (
    <div className="min-h-screen bg-light-bg dark:bg-dark-bg">
      ...
      <div className="bg-gradient-to-br from-green-50 to-lime-50 dark:from-gray-900 dark:to-black border-b-4 border-primary">
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          <div className="text-center">
            {/* Logo */}
            <div className="mb-8">
              <img 
                src="/woke-o-meter-logo.png" 
                alt="Woke-O-Meter Logo" 
